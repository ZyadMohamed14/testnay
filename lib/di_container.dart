...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => ConfigRepository(dioClient: sl(),
    sharedPreferences: sl(),
  ));

  sl.registerLazySingleton(() => ConfigCubit(sl()));
  // Repository
  sl.registerLazySingleton(() => CartRepository( sharedPreferences: sl()));
...
class Product {
  ...
  @override
  String toString() {
    return 'Product{_id: $_id, _name: $_name, _description: $_description, _variations: $_variations, _addOns: $_addOns, _availableTimeStarts: $_availableTimeStarts, _availableTimeEnds: $_availableTimeEnds, _status: $_status, _rating: $_rating, _isChanged: $_isChanged}';
  }
}
class BranchProduct {
  int? id;
...
class Rating {
  ...
  Rating({double? average, int? productId}) {
    _average = average;
